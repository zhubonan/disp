...
from disp.database.odm import SeedFile, ResFile, ResProperty, ParamFile, InitialStructureFile, DispEntry
...
def seed_l2fs():
    ...
    seed = SeedFile(content=content,
                    seed_name='2L2FS',
                    project_name='2L2FS/run1')
...
def param_l2fs():
    ...
    param = ParamFile(content=content,
                      seed_name='2L2FS',
                      project_name='2L2FS/run1')
    return param
...
def init_structure():
    ...
    init = InitialStructureFile(content=content,
                                seed_name='2L2FS',
                                project_name='2L2FS/run1',
                                struct_name='2L2FS-200625-100846-0e5188')
    return init
...
def test_seed_entry(new_db):
    ...
    seed2 = SeedFile(content=content,
                     seed_name='2L2FS',
                     project_name='2L2FS/run1')
...
def test_param_entry(new_db):
    ...
    param2 = ParamFile(content=content,
                       seed_name='2L2FS',
                       project_name='2L2FS/run1')
